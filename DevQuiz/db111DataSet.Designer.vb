...
Partial Public Class db111DataSet
    ...
    Private Sub InitClass()
        ...
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/db111DataSet.xsd"
...
Namespace db111DataSetTableAdapters
    ...
    Partial Public Class t1TableAdapter
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.DevQuiz.My.MySettings.Default.db111ConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(1).CommandText = "SELECT username, password, pname, planguage, timeleft, pscore FROM dbo.t1"
        ...
        Public Overloads Overridable Function FillBy(ByVal dataTable As db111DataSet.t1DataTable) As Integer
